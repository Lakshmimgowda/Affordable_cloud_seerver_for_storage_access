...
public class S3Interfacer {
    ...
    void uploadFileToCloud(String filename, String key) {
        ...
        s3.putObject(new PutObjectRequest("costeff1", key, new File(filename)));

        CloudClient.cl.writetolog("Uploaded the file: " + filename + " to cloud in bucket costeff1");
    ...
    void downloadFileFromCloud(String filename, String key) {
        ...
        S3Object object = s3.getObject(new GetObjectRequest("costeff1", key));
